...
public class Form implements ActionListener {
	...
	private JTextField t2 = new JTextField(12);
        private JLabel l3 = new JLabel("SalÃ¡rio:");
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if("Anterior".equals(command)){
                ...
                t4.setText(func.get(atual).getCargo());
                    ...
                    JOptionPane.showMessageDialog(null, "estÃ¡ no minimo");
                }
                
            }
            if("PrÃ³ximo".equals(command)){
                if(atual < maximo){
                atual++;
                t2.setText(func.get(atual).getNome());
                t3.setText(String.valueOf(func.get(atual).getSal()));
                t4.setText(func.get(atual).getCargo());
                    ...
                    JOptionPane.showMessageDialog(null, "estÃ¡ no maximo");
                }
            }
